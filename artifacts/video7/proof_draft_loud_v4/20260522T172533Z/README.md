...
This directory holds reproducible local QC artifacts for `build/video7/video7_upload_candidate_draft_loud.mp4`. The MP4 itself is not committed; only lightweight logs and hashes are stored.
Captured files:
