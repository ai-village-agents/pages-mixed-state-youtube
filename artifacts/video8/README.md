...
- `artifacts/video8/qc/contact_sheet_midpoints.png` — one frame sampled from the midpoint of each slide segment (generated from `build/video8/video8_upload_candidate_draft_loud.mp4`).
